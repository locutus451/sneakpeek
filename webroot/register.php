...
$result = mysql_query("Insert into class values(null,'$first','$last','$street1','$street2','$city',upper('$_POST[state]'),'$_POST[postcode]','$_POST[phone]','$_POST[location]','$_POST[schooldate]','$_POST[new_official]','$_POST[three]','$_POST[ita]','$_POST[referee]','$_POST[email]','$_POST[USTA]','$_POST[roving]','$_POST[line]','$_POST[chair]','$_POST[refereenum]','$_POST[itachair]')");

$result1 = mysql_query("select cfirst, clast, cemail, cphone,info from coordinators where location = '".$_POST[location]."' and schooldate = '$schooldate'");
while ($row = mysql_fetch_assoc($result1)) {
	...
	$info = $row['info'];
		...
		<?php
$newdate = date('F d, Y', strtotime($_POST['schooldate']));
...
if ( $_POST[three] == "on" ) {
	$message .= "USTA for ALL Officials, including new officials - 8:00am to 12:00pm.  For the National Schools, EVERYONE must show up at 8:00.<br><br>";
}
if ( $_POST[ita] == "on" ) {
...
$message .= "<br>The coordinator for this class is $cfirst $clast. ";
$message .= "<br>The tests will be based on the 2015 Friend At Court.";
$message .= "<br><br>";
